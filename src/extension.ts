...
async function getCommentFromChatGPT(functionName: string, functionBody: string): Promise<string> {
    try {
        ...
        console.error('Failed to get comment from ChatGPT:', error);
        return '';
    }
}
...
export function activate(context: ExtensionContext) {
    let disposable = commands.registerCommand('extension.addCommentsAboveFunctions', addCommentsAboveFunctions);
